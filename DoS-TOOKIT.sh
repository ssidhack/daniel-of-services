...
yellow='\033[33;1m'
clear
toilet -f slant " DOSS TOOLKIT " |lolcat


figlet -f slant "CLAY INDONESIA" |lolcat


echo
echo
echo $white" |---------------------------------------|"
echo $red" |    AUTOUR AND MODDED=GOSH/SIIDHAX     |"
echo $red" |               VERSION=1.2             |"
echo $red" |          CLAY TEAM INDONESIA          |"
echo $white" |---------------------------------------|"
echo $green" |      DOS WIN32,64 NT AND ANDROMEDA    |"
echo $red" |           CLAY HACKER TEAM            |"
echo $white" |---------------------------------------|"
echo $purple" |                 LIST                  |"
echo $white" |---------------------------------------|"
